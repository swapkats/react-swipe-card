  ...
  _createClass(DraggableCard, [{
    ...
    value: function render() {
      var _state2 = this.state,
          ...
          beingSwiped = _state2.beingSwiped,
          pristine = _state2.pristine,
          initialPosition = _state2.initialPosition,
          swipeDirection = _state2.swipeDirection;
      // console.log(beingSwiped);

      var style = (0, _utils.translate3d)(x, y, beingSwiped, initialPosition);
      return _react2.default.createElement(_SimpleCard2.default, _extends({}, this.props, { beingSwiped: beingSwiped, swipeDirection: swipeDirection, style: style, className: animation ? 'animate' : pristine ? 'inactive' : '' }));
    }
  }]);
